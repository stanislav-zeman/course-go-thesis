...
\noindent
The third section introduces the concept of channels as a means of communication for concurrent processes. Multiple diagrams were created to better showcase some of the most common channel interactions and edge cases, such as the one in \cref{fig:goroutine-interactions}. The channels section also discussed various patterns commonly used in concurrent systems like fan-in, fan-out, or pipeline.

\begin{figure}[H]
    \centering
    \includegraphics[width=11cm]{figures/buffered-full.png}
    \caption{Two goroutines interacting using a buffered channel.}
