...
This course is somewhat inspired by an existing course taught at FI MUNI called Programming in Rust 
...
As great of an experience as it was, the course certainly had its shortcomings. Docker, for example, was not properly introduced even though it was never even mentioned in its prerequisites. Some Docker knowledge was, therefore, implicitly expected. To this day, only a single optional course
\footnote{See \url{https://is.muni.cz/predmet/fi/jaro2024/PB176?lang=en}.}
delves into the topics of containerization with practical applications.
...
After a successful end of the first run, we 
