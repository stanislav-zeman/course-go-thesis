...
This section describes courses that try to provide practical knowledge or somehow relate to the discussed topics. All of the described courses are mentioned in the \cref{de}
...
The newly created course is intended to be taught throughout the span of twelve weeks. The first eleven weeks are regular lessons, and the last week is reserved for consultation or as a potential substitute class.
...
\section{Reflecting on existing courses}\label{reflect-course}
