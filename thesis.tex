...
\subsubsection{Sneakpeek to the new course outline}
...
All of the course materials are publicly accessible on GitHub. The respective links are provided in the \cref{apendix-materials}.
...
The last section introduces all major cloud providers (Amazon, Microsoft, and Google) and further develops into Google Cloud Platform (GCP)\cite{gcp}. As Google offers free credits thanks to the faculty program\cite{gcp-faculty}, it is a great opportunity for students to get their hands on operating cloud infrastructure. A set of basic services that GCP offers are introduced so students can leverage these in their follow-up projects.
